...
public class TurretSettings : ScriptableObject
{
    ...
    [field: SerializeField]
    [field: Range(.0f, 360f)]
    public float FieldAngle { get; private set; }

    [field: SerializeField]
    [field: Range(.0f, 1)]
    public float FOVCheckTime { get; private set; }

    [field: SerializeField]
    [field: Range(1, 120)]
    public int FOVLineCount { get; private set; }

    [field: SerializeField]
    [field: Min(0)]
    public float OffsetToRotation { get; private set; }
    ...
    [field: SerializeField]
    [field: Min(0)]
    public float RotateSpeed { get; private set; } = 2f;
    ...
    [field: SerializeField]
    [field: Range(.0f, 10)]
    public float ShootCheckTime { get; private set; }
